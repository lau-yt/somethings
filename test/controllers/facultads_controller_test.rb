...
class FacultadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facultad" do
    assert_difference('Facultad.count') do
      post facultads_url, params: { facultad: { nombre: @facultad.nombre, ubicacion: @facultad.ubicacion } }
    end
  ...
  test "should update facultad" do
    patch facultad_url(@facultad), params: { facultad: { nombre: @facultad.nombre, ubicacion: @facultad.ubicacion } }
